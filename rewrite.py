...
def muse(out_a, out_b, out_c, out_d, feed_w, feed_x, feed_y, feed_z):
    """Generate output of the Triadex Muse."""
...
if __name__ == "__main__":
    semitone = muse(out_a=17, out_b=17, out_c=18, out_d=19, feed_w=4, feed_x=19, feed_y=8, feed_z=5)
    ...
    while True:
        steps = next(semitone)
        print(steps)
        freq = root_hz * half_step_ratio ** steps
